                                            ...
                                            <div class="row">
                                                <article class="article col-md-4 mini">
                                                    <div class="inner">
                                                        <figure>
                                                            <a href="single.html">
                                                                <img src="{{ asset('home/images/news/img10.jpg') }}"
                                                                    alt="Sample Article">
                                                            </a>
                                                        </figure>
                                                        <div class="padding">
                                                ...
                                                <article class="article col-md-4 mini">
                                                    <div class="inner">
                                                        <figure>
                                                            <a href="single.html">
                                                                <img src="{{ asset('home/images/news/img11.jpg') }}"
                                                                    alt="Sample Article">
                                                            </a>
                                                        </figure>
                                                        <div class="padding">
                                                ...
                                                <article class="article col-md-4 mini">
                                                    <div class="inner">
                                                        <figure>
                                                            <a href="single.html">
                                                                <img src="{{ asset('home/images/news/img14.jpg') }}"
                                                                    alt="Sample Article">
                                                            </a>
                                                        </figure>
                                                        <div class="padding">
                                                            <div class="detail">
                                                                ...
                                                                <div class="category"><a
                                                                        href="category.html">Travel</a></div>
                                                            </div>
                                                            <h2><a href="single.html">Duis aute irure dolor in
                                                                    reprehenderit in voluptate</a></h2>
                                                        </div>
                    ...
                    <div class="owl-carousel owl-theme slide owl-carousel-1 tranding-carousel" id="featured">
                        <div class="item">
                            <article class="featured">
                                ...
                                <figure>
                                    <img src="{{ asset('home/images/news/img04.jpg') }}" alt="Sample Article">
                                </figure>
                                <div class="details">
                        ...
                        <div class="item">
                            <article class="featured">
                                <div class="overlay"></div>
                                <figure>
                                    <img src="{{ asset('home/images/news/img14.jpg') }}" alt="Sample Article">
                                </figure>
                                <div class="details">
                        ...
                        <div class="item">
                            <article class="featured">
                                <div class="overlay"></div>
                                <figure>
                                    <img src="{{ asset('home/images/news/img13.jpg') }}" alt="Sample Article">
                                </figure>
                                <div class="details">
                        ...
                        <div class="item">
                            <article class="featured">
                                <div class="overlay"></div>
                                <figure>
                                    <img src="{{ asset('home/images/news/img05.jpg') }}" alt="Sample Article">
                                </figure>
                                <div class="details">
                            ...
                            <div class="row">
                                ...
                                <article class="article col-md-12">
                                    <div class="inner">
                                        <figure>
                                            <a href="single.html">
                                                <img src="{{ asset('home/images/news/img06.jpg') }}"
                                                    alt="Sample Article">
                                            </a>
                                        </figure>
                                        <div class="padding">
