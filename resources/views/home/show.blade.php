                    ...
                    <div class="aside-body">
                        <article class="article-fw">
                            <div class="inner">
                                <figure>
                                    <a href="single.html">
                                        <img src="{{ asset('home/images/news/img16.jpg') }} ">
                                    </a>
                                </figure>
                                <div class="details">
                        ...
                        <article class="article-mini">
                            <div class="inner">
                                <figure>
                                    <a href="single.html">
                                        <img src="{{ asset('home/images/news/img05.jpg') }}">
                                    </a>
                                </figure>
                                <div class="padding">
                        ...
                        <article class="article-mini">
                            <div class="inner">
                                <figure>
                                    <a href="single.html">
                                        <img src="{{ asset('home/images/news/img02.jpg') }}">
                                    </a>
                                </figure>
                                <div class="padding">
                        ...
                        <article class="article-mini">
                            <div class="inner">
                                <figure>
                                    <a href="single.html">
                                        <img src="{{ asset('home/images/news/img13.jpg') }}">
                                    </a>
                                </figure>
                                <div class="padding">
                                    <h1><a href="single.html">Duis aute irure dolor in reprehenderit in voluptate velit</a></h1>
            ...
            <div class="col-md-8">
                ...
                <article class="article main-article">
                    ...
                    <div class="main">
                        ...
                        <div class="featured">
                            <figure>
                                <img src="{{ asset('home/images/news/img01.jpg') }}">
                ...
                <div class="author">
                    <figure>
                        <img src="{{ asset('home/images/img01.jpg') }}">
                    </figure>
                    <div class="details">
