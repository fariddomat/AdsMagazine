        ...
        <div class="col-12">
            <div class="card ">
                <div class="card-header">
                    <h4 class="card-title">All adSlots</h4>
                ...
                <div class="card-content collapse show">
                    <div class="card-body ">
                        ...
                        <a href="{{ route('dashboard.adSlots.create') }}"
                    ...
                    <div class="text-center m-auto">{{ $adSlots->appends(request()->query())->links() }}
                    </div>
                    @endif
